...
C_SRCS += \
../coines-api/mcu_app30/bootloaders/common/gcc_syscalls.c 

OBJS += \
./coines-api/mcu_app30/bootloaders/common/gcc_syscalls.o 

C_DEPS += \
./coines-api/mcu_app30/bootloaders/common/gcc_syscalls.d 


# Each subdirectory must supply rules for building sources it contributes
coines-api/mcu_app30/bootloaders/common/%.o: ../coines-api/mcu_app30/bootloaders/common/%.c
