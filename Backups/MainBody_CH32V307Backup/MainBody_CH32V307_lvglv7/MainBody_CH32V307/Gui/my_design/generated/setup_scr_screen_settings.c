...
//	lv_obj_set_size(ui->screen_settings_page, 1200, 240);
	...
	ui->screen_settings_btn_network = lv_btn_create(scroll, NULL);
	...
	ui->screen_settings_btn_rtdata = lv_btn_create(scroll, NULL);
	...
	ui->screen_settings_btn_devicest = lv_btn_create(scroll, NULL);
	...
	ui->screen_settings_btn_alarmset = lv_btn_create(scroll, NULL);
