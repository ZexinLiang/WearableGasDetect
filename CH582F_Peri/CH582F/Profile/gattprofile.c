...
static uint8_t simpleProfileChar2Props = GATT_PROP_WRITE|GATT_PROP_WRITE_NO_RSP;
...
static uint8_t simpleProfileChar3Props = GATT_PROP_WRITE|GATT_PROP_READ|GATT_PROP_WRITE_NO_RSP;
