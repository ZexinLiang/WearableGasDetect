...
void LCD_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2)
{
    ...
    {
        LCD_Fast_DrawPoint(uRow,uCol,BLACK);//画点
        xerr+=delta_x ;
        yerr+=delta_y ;
        if(xerr>distance)
        {
...
/*****************************************************************************
 * @name       :void LCD_DrawCircle(int xc, int yc,u16 c,int r, int fill)
 * @date       :2018-08-09
...
/*****************************************************************************
 * @name       :void LCD_DrawCircle_8(int xc, int yc, int x, int y, u16 c)
 * @date       :2018-08-09
