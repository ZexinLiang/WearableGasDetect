...
C_SRCS += \
../Gui/examples/libs/gif/img_bulb_gif.c \
../Gui/examples/libs/gif/lv_example_gif_1.c 

C_DEPS += \
./Gui/examples/libs/gif/img_bulb_gif.d \
./Gui/examples/libs/gif/lv_example_gif_1.d 

OBJS += \
./Gui/examples/libs/gif/img_bulb_gif.o \
./Gui/examples/libs/gif/lv_example_gif_1.o 



# Each subdirectory must supply rules for building sources it contributes
Gui/examples/libs/gif/%.o: ../Gui/examples/libs/gif/%.c
