...
void setup_scr_screen_rtdata(lv_ui *ui){
	...
	//Widget: screen_rtdata_cont_1
	ui->screen_rtdata_cont_1 = lv_cont_create(ui->screen_rtdata, NULL);
	lv_obj_set_click(ui->screen_rtdata_cont_1, false);
	lv_cont_set_layout(ui->screen_rtdata_cont_1, LV_LAYOUT_OFF);
	lv_cont_set_fit(ui->screen_rtdata_cont_1, LV_FIT_NONE);
	lv_obj_set_pos(ui->screen_rtdata_cont_1, 0, 0);
	lv_obj_set_size(ui->screen_rtdata_cont_1, 320, 240);

	//Set style for screen_rtdata_cont_1. Part: LV_CONT_PART_MAIN, State: LV_STATE_DEFAULT
	static lv_style_t style_screen_rtdata_cont_1_main_default;
	lv_style_reset(&style_screen_rtdata_cont_1_main_default);
	lv_style_set_bg_opa(&style_screen_rtdata_cont_1_main_default, LV_STATE_DEFAULT, 255);
	lv_style_set_bg_color(&style_screen_rtdata_cont_1_main_default, LV_STATE_DEFAULT, lv_color_hex(0xc6ebff));
	lv_style_set_radius(&style_screen_rtdata_cont_1_main_default, LV_STATE_DEFAULT, 0);
	lv_style_set_shadow_width(&style_screen_rtdata_cont_1_main_default, LV_STATE_DEFAULT, 0);
	lv_style_set_border_width(&style_screen_rtdata_cont_1_main_default, LV_STATE_DEFAULT, 1);
	lv_style_set_border_opa(&style_screen_rtdata_cont_1_main_default, LV_STATE_DEFAULT, 255);
	lv_style_set_border_color(&style_screen_rtdata_cont_1_main_default, LV_STATE_DEFAULT, lv_color_hex(0x999999));
	lv_obj_add_style(ui->screen_rtdata_cont_1, LV_CONT_PART_MAIN, &style_screen_rtdata_cont_1_main_default);

	//Widget: screen_rtdata_temp_txt
	ui->screen_rtdata_temp_txt = lv_label_create(ui->screen_rtdata_cont_1, NULL);
	...
	ui->screen_rtdata_rh_txt = lv_label_create(ui->screen_rtdata_cont_1, NULL);
	...
	ui->screen_rtdata_pres_txt = lv_label_create(ui->screen_rtdata_cont_1, NULL);
	...
	ui->screen_rtdata_temp = lv_label_create(ui->screen_rtdata_cont_1, NULL);
	...
	ui->screen_rtdata_rhu = lv_label_create(ui->screen_rtdata_cont_1, NULL);
	...
	ui->screen_rtdata_pres = lv_label_create(ui->screen_rtdata_cont_1, NULL);
	...
	ui->screen_rtdata_menu = lv_btn_create(ui->screen_rtdata_cont_1, NULL);
	...
	ui->screen_rtdata_pwr_pic = lv_bar_create(ui->screen_rtdata_cont_1, NULL);
	...
	ui->screen_rtdata_pwr = lv_label_create(ui->screen_rtdata_cont_1, NULL);
