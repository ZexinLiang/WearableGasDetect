...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_1_img_1, &_58DC9A2F81E0F053C85B9185A7294362_alpha_213x102);
    lv_img_set_pivot(ui->screen_1_img_1, 50,50);
    lv_img_set_angle(ui->screen_1_img_1, 0);
    lv_obj_set_pos(ui->screen_1_img_1, 53, 69);
    lv_obj_set_size(ui->screen_1_img_1, 213, 102);
